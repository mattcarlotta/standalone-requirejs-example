requirejs(["react", "react-dom", './h1button'], function(React, ReactDOM, H1LikeButton) {
"use strict";
...
ReactDOM.render(React.createElement(LikeButton, null), document.querySelector("#root"));
});
